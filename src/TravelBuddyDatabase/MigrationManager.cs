    ...
    public class MigrationManager : IDbContextFactory<ApplicationDbContext>
    {
        public ApplicationDbContext Create(DbContextFactoryOptions options)
        {
            var connectionString = options.EnvironmentName == "Production"
                ? "Server=tcp:a4amv.database.windows.net,1433;Initial Catalog=A4AMV;Persist Security Info=False;User ID=stipekp;Password=SuperTajneHeslo1;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;"
